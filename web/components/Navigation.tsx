...
export function Navigation() {
  ...
  // next-themes resolves on mount only; render an inert icon until then so
  ...
  return (
    <nav className="relative border-b bg-card z-50">
      ...
      <div className="relative z-10 mx-auto flex h-14 max-w-7xl items-center px-3 sm:px-4 gap-3 sm:gap-6" ref={mobileMenuRef}>
        ...
        {mobileMenuOpen && (
          <div className="absolute left-0 top-full w-full border-b bg-card shadow-md md:hidden z-50">
            <div className="flex flex-col p-2 gap-1">
              ...
              {mounted && (
                <div className="mt-3 px-2 [&_button]:w-full">
                  <WalletConnectButton />
                </div>
              )}
            </div>
